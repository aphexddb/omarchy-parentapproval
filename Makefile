...
install: check-root-install build
	...
	install -Dm644 default/agents/skills/parentapproval/SKILL.md "$(DESTDIR)$(PREFIX)/share/omarchy-parentapproval/agents/skills/parentapproval/SKILL.md"
	rm -rf "$(DESTDIR)$(PREFIX)/share/omarchy-parentapproval/agents/skills/omarchy-parentapproval"
